...
import com.vigitrackecuador.despachoflotavigitrack.POO.cDespacho;
...
public class TarjetasActivity extends AppCompatActivity {
    ...
    {
        final ProgressDialog progressDialog = new ProgressDialog(TarjetasActivity.this);
        ...
        jsonArrayRequestDespachoVueltasPdf = new JsonArrayRequest(url_tarjetas, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response)
            {
                ...
                {
                    Toast.makeText(TarjetasActivity.this, "Tam : "+arrayListDespacho.size(), Toast.LENGTH_SHORT).show();
                }
                else{Toast.makeText(TarjetasActivity.this, "Error catch : VUELTA NO VALIDA ", Toast.LENGTH_SHORT).show();}
